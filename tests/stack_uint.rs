...
mod stack_uint_tests {
    ...
    fn stack_uint_test() -> Result<(), StackError> {
        // Test 0
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(0));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(0));
        assert_eq!(stack_item.bytes().len(), 0);

        // Test 1
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(1));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(1));
        assert_eq!(stack_item.bytes().len(), 1);

        // Test 2
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(2));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(2));
        assert_eq!(stack_item.bytes().len(), 1);

        // Test 3
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(3));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(3));
        assert_eq!(stack_item.bytes().len(), 1);

        // Test 10
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(10));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(10));
        assert_eq!(stack_item.bytes().len(), 1);

        // Test 100
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(100));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(100));
        assert_eq!(stack_item.bytes().len(), 1);

        // Test 255
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(255));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(255));
        assert_eq!(stack_item.bytes().len(), 1);

        // Test 256 (now we are in the 2-byte range)
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(256));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(256));
        assert_eq!(stack_item.bytes().len(), 2);

        // Test 1_000
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(1000));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(1000));
        assert_eq!(stack_item.bytes().len(), 2);

        // Test 10_000
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(10000));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(10000));
        assert_eq!(stack_item.bytes().len(), 2);

        // Test 65535
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(65535));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(65535));
        assert_eq!(stack_item.bytes().len(), 2);

        // Test 65536 (now we are in the 3-byte range)
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(65536));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(65536));
        assert_eq!(stack_item.bytes().len(), 3);

        // Test 100_000
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(100000));
        assert_eq!(stack_item.to_stack_uint().unwrap(), StackUint::from(100000));
        assert_eq!(stack_item.bytes().len(), 3);
        ...
        // Test 4,294,967,295
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(4_294_967_295_u64));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(4_294_967_296_u64));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(1000000000000_i64));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(1099511627775_i64));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(1099511627776_i64));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(18446744073709551616_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(4722366482869645213695_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(4722366482869645213696_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(1208925819614629174706175_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(1208925819614629174706176_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(309485009821345068724781055_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(309485009821345068724781056_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(79228162514264337593543950335_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(79228162514264337593543950336_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(20282409603651670423947251286015_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(20282409603651670423947251286016_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(5192296858534827628530496329220095_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(5192296858534827628530496329220096_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(1329227995784915872903807060280344575_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem =
            StackItem::from_stack_uint(StackUint::from(1329227995784915872903807060280344576_u128));
        assert_eq!(
            stack_item.to_stack_uint().unwrap(),
        ...
        let stack_item: StackItem = StackItem::from_stack_uint(StackUint::from(
        ...
        let stack_item: StackItem = StackItem::from_stack_uint(
