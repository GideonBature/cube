...
pub enum SwapoutSBEDecodeError {
    ...
    SwapoutSBERootAccountLengthPrefixExceedsPayload {
        root_len: usize,
        got_after_prefix: usize,
    },
    SwapoutSBERootAccountDecodeError,
    SwapoutSBEInsufficientBytesForTargetAndAmount {
        got_total: usize,
    },
    SwapoutSBEInsufficientBytesForPinlessSelfKind {
        got_total: usize,
    },
    SwapoutSBEInvalidPinlessSelfKindByte(u8),
    SwapoutSBETrailingBytesAfterSwapout {
        trailing: usize,
    },
}
