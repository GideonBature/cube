...
pub enum ConfigSBEDecodeError {
    ...
    ConfigSBEInsufficientBytesForRootAccountLengthPrefix {
        got_total: usize,
    },
    ConfigSBERootAccountLengthPrefixBytesConversionError,
    ConfigSBERootAccountLengthPrefixExceedsPayload {
        root_len: usize,
        got_after_prefix: usize,
    },
    ConfigSBERootAccountDecodeError(RootAccountSBEDecodeError),
    ConfigSBEInsufficientBytesForSecondaryAggregationPresenceFlag {
        got_total: usize,
    },
    ConfigSBEInsufficientBytesForSecondaryAggregationLengthPrefix {
        got_total: usize,
    },
    ...
    ConfigSBESecondaryAggregationPresenceLengthMismatch {
        key_len: usize,
    },
    ConfigSBEInsufficientBytesForProjectorConfigPresenceFlag {
        got_total: usize,
    },
    ConfigSBEInsufficientBytesForProjectorConfigPayload {
        got_total: usize,
    },
    ConfigSBEProjectorConfigPresenceMismatch,
    ConfigSBEInsufficientBytesForFlameConfigPresenceFlag {
        got_total: usize,
    },
    ConfigSBEInsufficientBytesForFlameConfigLengthPrefix {
        got_total: usize,
    },
    ConfigSBEFlameConfigLengthPrefixBytesConversionError,
    ConfigSBEFlameConfigLengthPrefixExceedsPayload {
        flame_len: usize,
        got_after_prefix: usize,
    },
    ConfigSBEFlameConfigDecodeError,
    ConfigSBEFlameConfigPresenceLengthMismatch {
        flame_len: usize,
    },
    ConfigSBEInsufficientBytesForTarget {
        got_total: usize,
    },
    ConfigSBETargetDecodeError(TargetSBEDecodeError),
    ConfigSBETrailingBytesAfterConfig {
        trailing: usize,
    },
}
